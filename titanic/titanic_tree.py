...
#%%
print(X_train.info())
columns_to_drop = ["Embarked","FamiliSize","PassengerId","Name","Cabin","HasCabin","SibSp"]
num_columns = ["Age","Fare","Parch"]
cat_columns_stay = ["Pclass","Sex","Ticket","Deck","IsAlone","Fare_cat","Title","HasCarer"]
...
# DecissionTree
# params = [{
#     'max_depth': [1,2,3,4,5,10, 30,  50, 70, 90, None],
#     'criterion':["entropy","gini"]    
# }]

# RandomForest
# params = [{
#     'max_depth': [5,10, 30,  50, 70, 90, None],
#     'criterion':["entropy","gini"],
#     'n_estimators':[5,10,50,100,250,500,900,1000],
...
# ]
grid = GridSearchCV(estimator = clf6, param_grid= params, scoring='roc_auc',n_jobs=-1,cv=12, verbose=100)
