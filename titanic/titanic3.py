...
#%%
print(X_train.info())
columns_to_drop = ["HasCarer","Age","FamiliSize","PassengerId","Name","Cabin","Fare_cat","Embarked","HasCabin","Title","SibSp","Deck"]
num_columns = ["Fare","Parch"]
...
# ]
grid = GridSearchCV(estimator = clf, param_grid= params, scoring='accuracy',n_jobs=-1,cv=5, verbose=100)
